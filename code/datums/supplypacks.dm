...
/datum/supply_packs/det_uniform
	name = "Detective Equipment"
	contains = list(/obj/item/clothing/suit/storage/det_suit,
...
/datum/supply_packs/plain_coat
	name = "Surplus Coats"
	contains = list(/obj/item/clothing/suit/storage/plaincoat,
					/obj/item/clothing/suit/storage/plaincoat,
					/obj/item/clothing/suit/storage/plaincoat,
					/obj/item/clothing/suit/storage/plaincoat)
	cost = 30
	containertype = /obj/structure/closet/crate
	containername = "Surplus Coats"
	group = "Miscellaneous"
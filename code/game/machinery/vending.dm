...
/obj/machinery/vending/cigarette
	...
	product_ads = "Probably not bad for you!;Don't believe the scientists!;It's good for you!;Don't quit, buy more!;Smoke!;Nicotine heaven.;Best cigarettes since 2150.;Award-winning cigs.;Try our new brands!"
	vend_delay = 34
	icon_state = "cigs"
	products = list(/obj/item/weapon/storage/box/matches = 10,/obj/item/weapon/lighter/random = 4,/obj/item/weapon/storage/box/cigs/pipers = 15,/obj/item/weapon/storage/box/cigs/puffs = 15,/obj/item/weapon/storage/box/cigs/fortyfives = 15,/obj/item/weapon/storage/box/cigs/gravestones = 15)
	contraband = list(/obj/item/weapon/lighter/zippo = 4,/obj/item/weapon/storage/box/cigs/firelights = 2,/obj/item/weapon/storage/box/cigs/sleeptights = 4)
	premium = list(/obj/item/clothing/mask/cigarette/cigar/havana = 2,  /obj/item/weapon/storage/fancy/cigars = 4)
	prices = list(/obj/item/weapon/storage/box/matches = 1,/obj/item/weapon/lighter/random = 2,/obj/item/weapon/storage/box/cigs/pipers = 15,/obj/item/weapon/storage/box/cigs/puffs = 15,/obj/item/weapon/storage/box/cigs/fortyfives = 15,/obj/item/weapon/storage/box/cigs/gravestones = 15)

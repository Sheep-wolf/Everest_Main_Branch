...
/datum/job/secparamed
	...
	minimal_access = list(access_security, access_sec_doors, access_brig, access_court, access_medical, access_morgue)

	equip(var/mob/living/carbon/human/H)
		if(!H)	return 0
		H.equip_to_slot_or_del(new /obj/item/device/radio/headset/headset_secmed(H), slot_l_ear)
		switch(H.backbag)
			if(2) H.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack/security(H), slot_back)
			if(3) H.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack/satchel_sec(H), slot_back)
			if(4) H.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack/satchel(H), slot_back)
		...
		H.equip_to_slot_or_del(new /obj/item/device/pda/security(H), slot_belt)
		H.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/labcoat/fieldmed(H), slot_wear_suit)
...
/datum/job/specialforces
	...
	equip(var/mob/living/carbon/human/H)
		...
		switch(H.backbag)
			...
			if(3) H.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack/satchel_sec(H), slot_back)
			if(4) H.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack/satchel(H), slot_back)
		var/suit_colour = pick(1, 2, 3, 4, 5, 6)
		if (suit_colour == 1)
			H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/security/tprt(H), slot_w_uniform)
			H.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/tprt/suit(H), slot_wear_suit)

		if (suit_colour == 2)
			H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/security/tprt/blue(H), slot_w_uniform)
			H.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/tprt/suit.blue(H), slot_wear_suit)

		if (suit_colour == 3)
			H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/security/tprt/brown(H), slot_w_uniform)
			H.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/tprt/suit/brown(H), slot_wear_suit)

		if (suit_colour == 4)
			H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/security/tprt/red(H), slot_w_uniform)
			H.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/tprt/suit/red(H), slot_wear_suit)

		if (suit_colour == 5)
			H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/security/tprt/green(H), slot_w_uniform)
			H.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/tprt/suit/green(H), slot_wear_suit)

		if (suit_colour == 6)
			H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/security/tprt/grey(H), slot_w_uniform)
			H.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/tprt/suit/grey(H), slot_wear_suit)

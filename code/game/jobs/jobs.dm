...
var/const/PARAMEDIC			=(1<<13)
var/const/SPECIAL_FORCES	=(1<<14)
...
var/const/SHUTTLE			=(1<<6)
var/const/GUEST				=(1<<14)
var/const/RESIDENT			=(1<<15)
var/const/STAFF				=(1<<16)
...
datum/preview/job/civilian/shuttle
	job_index=SHUTTLE
	uniform_state="robotics_s"

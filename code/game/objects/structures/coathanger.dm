/obj/structure/coatrack
	...
	var/list/allowed = list(/obj/item/clothing/suit/storage/labcoat, /obj/item/clothing/suit/storage/det_suit, /obj/item/clothing/suit/leathercoat, /obj/item/clothing/suit/browncoat, /obj/item/clothing/suit/neocoat)
...
/obj/structure/coatrack/update_icon()
	...
	if (istype(coat, /obj/item/clothing/suit/leathercoat))
		overlays += image(icon, icon_state = "coat_black")
	if (istype(coat, /obj/item/clothing/suit/neocoat))
		overlays += image(icon, icon_state = "coat_black")
	if (istype(coat, /obj/item/clothing/suit/browncoat))
		overlays += image(icon, icon_state = "coat_brown")
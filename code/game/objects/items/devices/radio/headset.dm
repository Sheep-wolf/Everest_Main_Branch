...
/obj/item/device/radio/headset/headset_secmed
	name = "sec-med radio headset"
	desc = "This is used by medically trained security staff. To access the security channel use :s, for medical, use :m."
	icon_state = "sec_headset"
	item_state = "headset"
	keyslot2 = new /obj/item/device/encryptionkey/headset_secmed

...
/obj/item/weapon/storage/backpack/lamech
	name = "worn medical box"
	desc = "A well-used looking medical box. It has various dents and scratches in it."
	icon_state = "satchel-lamech"
	item_state = "medicalpack"
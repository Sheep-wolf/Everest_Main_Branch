...
/obj/item/weapon/storage/box/lovenote
	name = "delivery box (Marie Lamb)"
	desc = "A delivery for Marie."

	New()
		..()
		new /obj/item/weapon/gun/projectile/love/hugs(src)
		new /obj/item/weapon/gun/projectile/love/kisses(src)

/obj/item/weapon/storage/box/licenses
	name = "box of licenses"
	desc = "A box of firearm licenses."

	New()
		..()
		new /obj/item/weapon/license(src)
		new /obj/item/weapon/license(src)
		new /obj/item/weapon/license(src)
		new /obj/item/weapon/license(src)
		new /obj/item/weapon/license(src)

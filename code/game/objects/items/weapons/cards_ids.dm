...
/obj/item/weapon/card/id/captains_spare/clone
	name = "clonetrooper ID"
	desc = "A clonetroopers ID."
	icon_state = "clone"
	item_state = "card-id"
	registered_name = "Clonetrooper"

/obj/item/weapon/card/id/captains_spare/clone/cappy
	name = "captain ID"
	icon_state = "clone_cappy"
	registered_name = "Captain"

/obj/item/weapon/card/id/captains_spare/clone/commander
	name = "commander ID"
	icon_state = "clone_commander"
	registered_name = "Commander"

/obj/item/weapon/card/id/captains_spare/clone/sergeant
	name = "sergeant ID"
	icon_state = "clone_sergeant"
	registered_name = "Sergeant"

/obj/item/weapon/card/id/captains_spare/clone/lieutenant
	name = "lieutenant ID"
	icon_state = "clone_blue"
	registered_name = "Lieutenant"
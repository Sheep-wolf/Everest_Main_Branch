...
message = replacetextOLD(message, "l", "r")
message = replacetextOLD(message, "rr", "ru")
message = replacetextOLD(message, "v", "b")
message = replacetextOLD(message, "f", "hu")
message = replacetextOLD(message, "'t", "")
message = replacetextOLD(message, "t ", "to ")
message = replacetextOLD(message, " I ", " ai ")
message = replacetextOLD(message, "th", "z")
message = replacetextOLD(message, "ish", "isu")
message = replacetextOLD(message, "is", "izu")
message = replacetextOLD(message, "ziz", "zis")
message = replacetextOLD(message, "se", "su")
message = replacetextOLD(message, "br", "bur")
message = replacetextOLD(message, "ry", "ri")
message = replacetextOLD(message, "you", "yuu")
message = replacetextOLD(message, "ck", "cku")
message = replacetextOLD(message, "eu", "uu")
message = replacetextOLD(message, "ow", "au")
message = replacetextOLD(message, "are", "aa")
message = replacetextOLD(message, "ay", "ayu")
message = replacetextOLD(message, "ea", "ii")
message = replacetextOLD(message, "ch", "chi")
message = replacetextOLD(message, "than", "sen")
message = replacetextOLD(message, ".", "")

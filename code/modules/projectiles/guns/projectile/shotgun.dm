...
/obj/item/weapon/gun/projectile/shotgun/pump
	name = "shotgun"
	desc = "A compact combat shotgun with a thin metal stock and smooth wooden pump and handle."
	icon_state = "shotgun"
	item_state = "shotgun"
	max_shells = 4
	w_class = 4.0
...
/obj/item/weapon/gun/projectile/shotgun/pump/combat
	name = "combat shotgun"
	icon_state = "cshotgun"
	desc = "A solid and dependable shotgun, with a mixture of plastic, rubber, and metal parts."
	max_shells = 8

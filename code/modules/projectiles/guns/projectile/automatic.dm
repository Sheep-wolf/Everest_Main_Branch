/obj/item/weapon/gun/projectile/automatic //Hopefully someone will find a way to make these fire in bursts or something. --Superxpdude
	...
	New()
		..()
		empty_mag = new /obj/item/ammo_magazine/bc9mm/empty(src)
		update_icon()
		return
...
/obj/item/weapon/gun/projectile/automatic/mini_uzi
	...
	New()
		..()
		empty_mag = new /obj/item/ammo_magazine/c45u/empty(src)
		update_icon()
		return
...
/obj/item/weapon/gun/projectile/automatic/tommy
	name = "Tommygun"
	desc = "A Chicago-style typewriter, kapeesh? Uses .45 rounds."
	...
	New()
		..()
		empty_mag = new /obj/item/ammo_magazine/b45/empty(src)
		update_icon()
		return
...
/obj/item/weapon/gun/projectile/automatic/tommy/attackby(obj/item/weapon/W as obj, mob/user as mob)
	if(istype(W, /obj/item/weapon/screwdriver))
		if(tommy_stock == 1)
			tommy_stock = 0
			user << "<span class='notice'>You remove the stock, making the gun more compact!</span>"
			w_class = 3
			icon_state = "tommygun3"
			update_icon()
			return
			...
			tommy_stock = 1
			user << "<span class='notice'>You re-attatch the stock, making the gun more legal!</span>"
			w_class = 4
			icon_state = "tommygun"
			update_icon()
			return
...
*/
	...
	//start working on the different modifications, and don't forget to work on our plant friend too! (Under Flora in objects, if you forgot.)

/obj/item/weapon/gun/projectile/detective
	...
	verb/rename_gun()
		...
		if(M.mind.assigned_role != "Detective")
			M << "<span class='notice'>You'd feel silly walking around with a named gun.</span>"
			return 0
...
/obj/item/weapon/gun/projectile/detective/semiauto/privatecorps
	desc = "A moderately well-made replica of a Colt M1911. Uses .45 rounds."
...
/obj/item/weapon/gun/projectile/detective/secgun/New()
	..()
	empty_mag = new /obj/item/ammo_magazine/c45/empty(src)
	return

/obj/item/weapon/gun/projectile/detective/secgun/afterattack(atom/target as mob|obj|turf|area, mob/living/user as mob|obj, flag)
	..()
	if(!loaded.len && empty_mag)
		empty_mag.loc = get_turf(src.loc)
		empty_mag = null
...
/obj/item/weapon/gun/projectile/minirevolver
	name = ".22 Misorian revolver"
	desc = "A compact revolver. Uses .22 ammo."

...
/obj/item/projectile/energy/bolt/clara
	damage_type = BURN

/obj/item/projectile/energy/bolt/clara/heavy
	damage = 25
	agony = 10
	stutter = 5

/obj/item/projectile/energy/bolt/clara/smg
	damage = 25
	agony = 20
	stutter = 0

/obj/item/projectile/energy/bolt/clara/fire
	damage = 5
	agony = 0
	stutter = 0

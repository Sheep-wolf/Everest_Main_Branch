...
/obj/item/projectile/bullet/smallbullet
	damage = 15
...
/obj/item/projectile/bullet/midbullet2/silver
	//this is the set-up for vampires, would do 40 damage if vampire, else do only 25.
	//we need a check for if the mind is a vampires or not, then we base damage off that.

/obj/item/projectile/bullet/heavyhurt
	damage = 20
	agony = 40

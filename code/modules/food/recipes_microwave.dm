...
/datum/recipe/poundcake
	reagents = list("milk" = 15, "sugar" = 15)
	items = list(
		/obj/item/weapon/reagent_containers/food/snacks/dough,
		/obj/item/weapon/reagent_containers/food/snacks/dough,
		/obj/item/weapon/reagent_containers/food/snacks/dough,
	)
	result = /obj/item/weapon/reagent_containers/food/snacks/sliceable/poundcake

/datum/recipe/scrambledeggs
	reagents = list("milk" = 10)
	items = list(
		/obj/item/weapon/reagent_containers/food/snacks/egg
	)
	result = /obj/item/weapon/reagent_containers/food/snacks/scrambledeggs

/datum/recipe/scrambledeggschocolate
	reagents = list("milk" = 10)
	items = list(
		/obj/item/weapon/reagent_containers/food/snacks/chocolateegg
	)
	result = /obj/item/weapon/reagent_containers/food/snacks/scrambledeggschocolate

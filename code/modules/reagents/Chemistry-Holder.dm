...
////////////////////////////Three new procs for new drink handling//////////////////////////////////////////////////////////////

			get_master_reagent_description()
				var/the_desc = null
				var/the_volume = 0
				for(var/datum/reagent/A in reagent_list)
					if(A.volume > the_volume)
						the_volume = A.volume
						the_desc = A.description

				return the_desc


			get_master_reagent_dcolour()
				var/the_dcolour = null
				var/the_volume = 0
				for(var/datum/reagent/A in reagent_list)
					if(A.volume > the_volume)
						the_volume = A.volume
						the_dcolour = A.dcolour

		...
		if (reagents.reagent_list.len > 0)
			...
			switch(reagents.get_master_reagent_id())
				...
				if("eggnog")
					...
					desc = "Deck the halls with pounds of whatever you throw around when you're drunk!"
				if("mobconnection")
					icon_state = "mob_connection"
					name = "Glass of Mob Connection"
					desc = "What're you, a funny guy? It's a glass with a suit tie."
				if("lemongrenade")
					icon_state = "lemon_grenade"
					name = "Glass of Lemon Gren-Ade"
					desc = "An explosion of flavour!"
				if("freddiecoffee")
					icon_state = "freddiecoffee"
					name = "Glass of pink coffee"
					desc = "It's...pink coffee...hmm..."
				else
					icon_state ="glass_brown"
					name = "Glass of ..what?"

...
datum
	reagent
		...
		var/overdose = 0
		var/overdose_dam = 1
		var/dcolour = "glassbrown2" //Supposed to be used for a drink overhaul, allowing for the variables for it to be set here instead of in a huge shitty line.
...
///////////////////Sheep stuff/////////////////////////////////////////////////////
		...
		ethanol/mobconnection
			name = "Mob Connection"
			id = "mobconnection"
			description = "Comes in a variety of types"
			color = "#2E6671"
			boozepwr = 3
			confused_start = 300
			blur_start = 400
		...
		ethanol/freddiecoffee
			name = "Pink Coffee"
			id = "freddiecoffee"
			description = "Freddies favourite"
			boozepwr = 5

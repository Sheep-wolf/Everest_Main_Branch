...
//Sheep stuff, best stuff//

		eggnog
			name = "Eggnog"
			id = "eggnog"
			result = "eggnog"
			required_reagents = list("coco" = 1, "rum" = 1, "milk" = 2, "sugar" = 1)
			result_amount = 5

		mobconnection
			name = "Mob Connection"
			id = "mobconnection"
			result = "mobconnection"
			required_reagents = list("wine" = 1, "vodka" = 1)
			result_amount = 2
		...
		lemongrenade
			...
			id = "lemongrenade"
			result = "lemongrenade"
			required_reagents = list("grenadine" = 1, "lemonade" = 2)
			result_amount = 3
		...
		freddiecoffee
			...
			id = "freddiecoffee"
			result = "freddiecoffe"
			required_reagents = list("coffee" = 4, "absinthe" = 1)
			result_amount = 5

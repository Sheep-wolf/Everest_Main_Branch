...
/*
/obj/item/clothing/suit/storage/det_suit/armoured
	name = "armored coat"
	desc = "A coat with a layer of kevlar under it."
	icon_state = "armourjacket"
	armor = list(melee = 60, bullet = 60, laser = 40, energy = 40, bomb = 25, bio = 0, rad = 0)
*/
//Forensics
/obj/item/clothing/suit/storage/forensics
	...
	armor = list(melee = 10, bullet = 10, laser = 15, energy = 10, bomb = 0, bio = 10, rad = 0)

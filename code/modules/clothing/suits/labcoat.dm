...
//		switch(icon_state)
		if(labcoatbuttons == 1)
			icon_state = "[item_color]_top"
			usr << "You button up the labcoat's first button."
			labcoatbuttons = 2

		else if(labcoatbuttons == 2)
			src.icon_state = "[item_color]_all"
			usr << "You fully button the labcoat."
			labcoatbuttons = 3

		else if(labcoatbuttons == 3)
...
/obj/item/clothing/suit/storage/labcoat/science
	...
	item_color = "labcoat_tox"

/obj/item/clothing/suit/storage/labcoat/fieldmedrupert
	name = "Field-Med labcoat"
	desc = "A labcoat with a big red cross stitched to the back."
	icon_state = "rupert_open"
	item_color = "rupert"

/obj/item/clothing/suit/storage/labcoat/fieldmed
	name = "Field-Med labcoat"
	desc = "A labcoat with a big blue cross stitched to the back."
	icon_state = "fieldmed_open"
	item_color = "fieldmed"

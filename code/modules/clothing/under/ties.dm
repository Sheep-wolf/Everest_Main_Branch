...
/obj/item/clothing/tie/collar
	name = "collar"
	desc = "It seems too large for animals..."
	icon_state = "collar"
	item_color = "collar"

/obj/item/clothing/tie/collar/holo
	name = "holo collar"
	desc = "It has a holo tag, it seems too large for animals..."
...
/obj/item/clothing/tie/medal/misoria/jane
	name = "Misorian medal of bravery"
	desc = "A medal signifying bravery in the face of danger, not usually given to Misorian police."
	icon_state = "jane"
	item_color = "jane"
...
/obj/item/clothing/tie/wcoat
	name = "slim waistcoat"
	desc = "A black waistcoat, for wearing under a jacket or coat."
	icon_state = "vest"
	item_color = "vest"

//Could use item color in Armoured Jacket code so we can keep the code minimal.
/obj/item/clothing/tie/wcoat/red
	desc = "A red waistcoat, for wearing under a jacket or coat."
	icon_state = "redvest"
	item_color = "redvest"

/obj/item/clothing/tie/wcoat/purple
	desc = "A purple waistcoat, for wearing under a jacket or coat."
	icon_state = "purpvest"
	item_color = "purpvest"

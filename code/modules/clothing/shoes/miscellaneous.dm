...
/obj/item/clothing/shoes/stormtrooper
	name = "white boots"
	desc = "A solid pair of boots, A layer of protection protects the wearers shins."
	icon_state = "stormboots"
	item_state = "stormboots"
